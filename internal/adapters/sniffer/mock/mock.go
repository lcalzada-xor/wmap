...
func (m *MockSniffer) GetInterfaceChannels(ctx context.Context, iface string) ([]int, error) { return nil, nil }
func (m *MockSniffer) GetInterfaces(ctx context.Context) ([]string, error) { return nil, nil }
func (m *MockSniffer) GetInterfaceDetails(ctx context.Context) ([]domain.InterfaceInfo, error) { return nil, nil }
...
func (m *MockSniffer) ExecuteWithLock(ctx context.Context, iface string, channel int, action func() error) error { return nil }
